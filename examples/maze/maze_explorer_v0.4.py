...
# TODO, lets simplify, flatten into WALLS and VISITED globals, remove the class, use just functions
class MazeMap:
    def __init__(self):
        self.visited = set()
        self.walls = {}
...
def move_to_cell(robot, direction):
    ...
    """
    # TODO, i want simplify, lets discuss. may be we should just use all walls for aligning and min_distance
    # for ahead wall we don't need to maintain min_distance, but we can make min distance be a bit smaller than CENTER_DIST,
    # this will make us maintain angle and distance to all walls safely and robot will detect CENTER_DIST before reaching min distance
    ...
    # TODO, this looks identical to DIR_DELTA
