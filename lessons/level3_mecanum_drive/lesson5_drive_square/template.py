...
Drive in a perfect 1m × 1m square without rotating!

Target square:
- Each side: 1.0 meter
- Velocity: 0.2 m/s
- Time per side: distance / velocity = 1.0 / 0.2 = 5 seconds
...
def main():
    ...
    # TODO: Drive forward at VELOCITY
    # Hint: robot.drive.forward(VELOCITY)
    ...
    # TODO: Drive backward at VELOCITY
