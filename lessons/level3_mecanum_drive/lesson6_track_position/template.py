...
Use odometry to track robot position!

Instructions:
1. Create robot with mecanum drive
2. Display starting position
3. Drive and monitor position updates
4. Show how x, y, theta change with motion
...
def main():
    ...
    # TODO: Print starting position
    # Hint: print_pose(robot, "Starting position:")
    ...
    for i in range(6):
        ...
        # Hint: print_pose(robot, f"  {(i+1)*0.5:.1f}s:")
