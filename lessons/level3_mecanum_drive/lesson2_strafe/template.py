...
Move sideways like a crab - the magic of mecanum wheels!

Instructions:
1. Create robot with mecanum drive
2. Strafe left (sideways)
3. Strafe right (sideways)
4. Move diagonally (combine forward + strafe)
...
def main():
    ...
    # TODO: Strafe left at 0.2 m/s
    # Hint: robot.drive.strafe_left(???)
    ...
    # TODO: Strafe right at 0.2 m/s
    # Hint: robot.drive.strafe_right(???)
    ...
    # TODO: Move diagonally (forward + right)
    # Hint: robot.drive.move(vx=???, vy=???)
    # Remember: vx = forward/backward, vy = left/right (negative = right)
    ...
    # TODO: Move diagonally (backward + left)
    # Hint: vx negative = backward, vy positive = left
